...
export default function Topbar() {
    ...
    return (
        <div className="topbarWrapper">
            <NavLink exact to="/" className="nav-logo"><img src="https://hdn-1.fynd.com/company/884/applications/000000000000000000000001/application/pictures/free-logo/original/v6YLFKFeJ-Fynd.jpeg" /></NavLink>
                            ...
                            <div className="dropdown-flex">
                                ...
                                <div class="menu-content">
                                    {adminAuth ?
                                        ...
                                        :
                                        <>
                                            <NavLink exact className="links-hidden" to='/admin/sign-in'>Sell on fynd</NavLink>
                                        </>}
